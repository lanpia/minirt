...
/*   Updated: 2024/01/03 03:47:36 by nahyulee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_r(t_mlx mlx, char **data)
{
	if (ft_strcmp("R", data[0]) == 0)
	{
		mlx.width = ft_atoi(data[1]);
		mlx.height = ft_atoi(data[2]);
	}
	else
		ft_exit(1, "Error\nR is not exist\n");
}
